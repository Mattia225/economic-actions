document.addEventListener("DOMContentLoaded", () => {
    ...
    // --- Gestione fullscreen + cursor hide ---
    document.addEventListener('fullscreenchange', () => {
        if (document.fullscreenElement === wrapper) {
            ...
            // --- Cursor gestione ---
            wrapper.classList.remove('hide-cursor'); // reset
    ...
    function startCursorTimer() {
        ...
        cursorTimeout = setTimeout(() => {
            wrapper.classList.add('hide-cursor'); // aggiunge classe per nascondere cursore
        }, 2000);
    }

    function resetCursorTimer() {
        wrapper.classList.remove('hide-cursor'); // mostra cursore
        startCursorTimer(); // resetta timer
    }
});